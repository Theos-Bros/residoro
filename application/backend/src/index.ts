...
import { registerItinerarySettingsRoutes } from './routes/itinerarySettings.js';
import { registerLeadActivityLogRoutes } from './routes/leadActivityLog.js';
...
await registerItinerarySettingsRoutes(app);
await registerLeadActivityLogRoutes(app);
